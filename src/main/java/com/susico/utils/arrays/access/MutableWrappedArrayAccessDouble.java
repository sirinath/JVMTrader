...
public final class MutableWrappedArrayAccessDouble {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessDouble.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessDouble.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessDouble.class, "inc");

    public MutableWrappedArrayAccessDouble(final boolean SAFE, final double[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessDouble wrap(final @NotNull double[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessDouble checked(
        final boolean checked, final @NotNull double[] array) {
        return new MutableWrappedArrayAccessDouble(checked, array);
    }
    ...
    public static  MutableWrappedArrayAccessDouble unchecked(
        final @NotNull double[] array) {
