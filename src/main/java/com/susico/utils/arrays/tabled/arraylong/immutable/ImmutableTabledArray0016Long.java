...
public abstract class ImmutableTabledArray0016Long extends
    ImmutableTabledArray0008Long {
    
    protected final static long value0008FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0008");

    protected final @NotNull long value0008;

    protected final static long value0009FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0009");

    protected final @NotNull long value0009;

    protected final static long value0010FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0010");

    protected final @NotNull long value0010;

    protected final static long value0011FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0011");

    protected final @NotNull long value0011;

    protected final static long value0012FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0012");

    protected final @NotNull long value0012;

    protected final static long value0013FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0013");

    protected final @NotNull long value0013;

    protected final static long value0014FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0014");

    protected final @NotNull long value0014;

    protected final static long value0015FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0016Long.class, "value0015");

    protected final @NotNull long value0015;
    ...
    protected ImmutableTabledArray0016Long(
    ...
    public static  ImmutableTabledArray0016Long getInstance(
        final boolean checked, final int length, final @NotNull long ... values) {
