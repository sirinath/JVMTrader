...
public final class MutableWrappedArrayAccessChar {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessChar.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessChar.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessChar.class, "inc");

    public MutableWrappedArrayAccessChar(final boolean SAFE, final char[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessChar wrap(final @NotNull char[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessChar checked(
        final boolean checked, final @NotNull char[] array) {
        return new MutableWrappedArrayAccessChar(checked, array);
    }
    ...
    public static  MutableWrappedArrayAccessChar unchecked(
        final @NotNull char[] array) {
