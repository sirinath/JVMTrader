...
public abstract class ImmutableTabledArray0000Double
    extends ImmutableTabledArrayDouble {
    protected ImmutableTabledArray0000Double(final boolean checked, final int length, final @NotNull double ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0000Double(
    ...
    public static  ImmutableTabledArray0000Double getInstance(
