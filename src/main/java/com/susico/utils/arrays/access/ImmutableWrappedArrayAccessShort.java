...
public final class ImmutableWrappedArrayAccessShort {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessShort.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessShort.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessShort.class, "inc");

    public ImmutableWrappedArrayAccessShort(final boolean SAFE, final short[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public static  ImmutableWrappedArrayAccessShort checked(
        final boolean checked, final @NotNull short[] array) {
        return new ImmutableWrappedArrayAccessShort(checked, array);
    }
    ...
    public static  ImmutableWrappedArrayAccessShort unchecked(
        final @NotNull short[] array) {
