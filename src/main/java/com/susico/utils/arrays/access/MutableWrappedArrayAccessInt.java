...
public final class MutableWrappedArrayAccessInt {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessInt.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessInt.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessInt.class, "inc");

    public MutableWrappedArrayAccessInt(final boolean SAFE, final int[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessInt wrap(final @NotNull int[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessInt checked(
        final boolean checked, final @NotNull int[] array) {
        return new MutableWrappedArrayAccessInt(checked, array);
    }
    ...
    public static  MutableWrappedArrayAccessInt unchecked(
        final @NotNull int[] array) {
