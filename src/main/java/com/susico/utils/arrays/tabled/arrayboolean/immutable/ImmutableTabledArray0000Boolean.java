...
public abstract class ImmutableTabledArray0000Boolean
    extends ImmutableTabledArrayBoolean {
    protected ImmutableTabledArray0000Boolean(final boolean checked, final int length, final @NotNull boolean ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0000Boolean(
    ...
    public static  ImmutableTabledArray0000Boolean getInstance(
