...
public abstract class ImmutableTabledArray0000Short
    extends ImmutableTabledArrayShort {
    protected ImmutableTabledArray0000Short(final boolean checked, final int length, final @NotNull short ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0000Short(
    ...
    public static  ImmutableTabledArray0000Short getInstance(
