...
public abstract class ImmutableTabledArray0008Double extends
    ImmutableTabledArray0004Double {
    
    protected final static long value0004FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0008Double.class, "value0004");

    protected final @NotNull double value0004;

    protected final static long value0005FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0008Double.class, "value0005");

    protected final @NotNull double value0005;

    protected final static long value0006FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0008Double.class, "value0006");

    protected final @NotNull double value0006;

    protected final static long value0007FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0008Double.class, "value0007");

    protected final @NotNull double value0007;
    ...
    protected ImmutableTabledArray0008Double(
    ...
    public static  ImmutableTabledArray0008Double getInstance(
        final boolean checked, final int length, final @NotNull double ... values) {
