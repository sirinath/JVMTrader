...
public abstract class MutableTabledArrayFloat extends ImmutableTabledArrayFloat {
    ...
    public static  MutableTabledArrayFloat getInstance(final boolean checked, final int length, final float ... values) {
        switch (length) {
            ...
            case 2048: 
                return MutableTabledArray2048Float.getInstance(checked, values);
            ...
            case 4096: 
                return MutableTabledArray4096Float.getInstance(checked, values);
            ...
            case 8192: 
                return MutableTabledArray8192Float.getInstance(checked, values);
