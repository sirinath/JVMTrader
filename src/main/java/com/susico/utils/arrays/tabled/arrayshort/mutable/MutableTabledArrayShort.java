...
public abstract class MutableTabledArrayShort extends ImmutableTabledArrayShort {
    protected MutableTabledArrayShort(final boolean checked, final int definedAsValues, final int length, final @NotNull short ... values) {
        super(checked, definedAsValues, length, values);
    }

    protected final void putToRest(final int index, final @NotNull short value) {
        ARRAY_ACCESS.put(index - definedAsValues, (short[]) rest, (short) value);
    }

    protected final void putVolatileToRest(final int index, final @NotNull short value) {
        ARRAY_ACCESS.putVolatile(index - definedAsValues, (short[]) rest, (short) value);
    }

    public abstract void put(final int index, final @NotNull short value);

    public abstract void putUnsafe(final int index, final @NotNull short value);

    public abstract void putVolatile(final int index, final @NotNull short value);

    public static  MutableTabledArrayShort getInstance(
