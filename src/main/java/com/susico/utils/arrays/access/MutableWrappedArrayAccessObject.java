...
public final class MutableWrappedArrayAccessObject<T> {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessObject.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessObject.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessObject.class, "inc");

    public MutableWrappedArrayAccessObject(final boolean SAFE, final T[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessObject<T> wrap(final @NotNull T[] array) {
        try {
            while (wrapGuard)
    ...
    public static <T> MutableWrappedArrayAccessObject<T> checked(
        final boolean checked, final @NotNull T[] array) {
        return new MutableWrappedArrayAccessObject<T>(checked, array);
    }
    ...
    public static <T> MutableWrappedArrayAccessObject<T> unchecked(
        final @NotNull T[] array) {
