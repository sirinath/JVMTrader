...
public abstract class ImmutableTabledArrayChar extends TabledArray {
    ...
    protected ImmutableTabledArrayChar(final boolean checked, final int definedAsValues, final char ... values) {
        super(checked, definedAsValues, values.length);
        this.rest = new char[length > definedAsValues ? length - definedAsValues : 0];
    ...
    protected final char getFromRest(int index) {
    ...
    public static  ImmutableTabledArrayChar getInstance(final boolean checked, final int length, final char ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Char.getInstance(checked, values);
            case 1:
                return ImmutableTabledArray0001Char.getInstance(checked, values);
            case 2: 
                return ImmutableTabledArray0002Char.getInstance(checked, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Char.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Char.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Char.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Char.getInstance(checked, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Char.getInstance(checked, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Char.getInstance(checked, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Char.getInstance(checked, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Char.getInstance(checked, values);
            ...
            case 1024: 
                return ImmutableTabledArray1024Char.getInstance(checked, values);
            ...
            case 2048: 
                return ImmutableTabledArray2048Char.getInstance(checked, values);
            ...
            case 4096: 
                return ImmutableTabledArray4096Char.getInstance(checked, values);
            ...
            case 8192: 
                return ImmutableTabledArray8192Char.getInstance(checked, values);
