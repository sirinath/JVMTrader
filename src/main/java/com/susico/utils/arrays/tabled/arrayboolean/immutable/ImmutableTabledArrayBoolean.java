...
public abstract class ImmutableTabledArrayBoolean extends TabledArray {
    protected final boolean[] rest;
    protected final int actualLength;

    protected ImmutableTabledArrayBoolean(final boolean checked, final int definedAsValues, final int length, final @NotNull boolean ... values) {
        super(checked, definedAsValues, length);

        final int effectiveLength = Math.max(length, values.length);
        rest = new boolean[effectiveLength > definedAsValues ? effectiveLength - definedAsValues : 0];
    ...
    protected final @NotNull boolean getFromRest(final int index) {
        return (boolean) ARRAY_ACCESS.get(index - definedAsValues, (boolean[]) rest);
    }

    protected final @NotNull boolean getVolatileFromRest(final int index) {
        return (boolean) ARRAY_ACCESS.getVolatile(index - definedAsValues, (boolean[]) rest);
    }

    public abstract boolean get(final int index);

    public abstract boolean getUnsafe(final int index);

    public abstract boolean getVolatile(final int index);

    public static  ImmutableTabledArrayBoolean getInstance(
        final boolean checked, final int length, final @NotNull boolean ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Boolean.getInstance(checked, length, values);
            case 1:
                return ImmutableTabledArray0001Boolean.getInstance(checked, length, values);
            case 2: 
                return ImmutableTabledArray0002Boolean.getInstance(checked, length, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Boolean.getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Boolean.getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Boolean.getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Boolean.getInstance(checked, length, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Boolean.getInstance(checked, length, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Boolean.getInstance(checked, length, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Boolean.getInstance(checked, length, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Boolean.getInstance(checked, length, values);
