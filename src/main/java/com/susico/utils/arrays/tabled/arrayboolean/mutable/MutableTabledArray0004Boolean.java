...
public abstract class MutableTabledArray0004Boolean extends MutableTabledArray0002Boolean {
    ...
    protected MutableTabledArray0004Boolean(final boolean checked, final int length, final boolean ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0004Boolean(final boolean checked, final int definedAsValues, final int length, final boolean ... values) {
    ...
    public static  MutableTabledArray0004Boolean getInstance(final boolean checked, final int length, final boolean ... values) {
