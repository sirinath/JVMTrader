...
public abstract class ImmutableTabledArray0004Char extends ImmutableTabledArray0002Char {
    ...
    protected ImmutableTabledArray0004Char(final boolean checked, final char ... values) {
        this(checked, 0, values);
    }

    protected ImmutableTabledArray0004Char(final boolean checked, final int definedAsValues, final char ... values) {
    ...
    public static  ImmutableTabledArray0004Char getInstance(final boolean checked, final char ... values) {
        return new ImmutableTabledArray0004Char(checked, values) {
