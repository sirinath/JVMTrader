...
public abstract class ImmutableTabledArrayChar extends TabledArray {
    ...
    protected ImmutableTabledArrayChar(final boolean checked, final int definedAsValues, final int length, final @NotNull char ... values) {
    ...
    protected final @NotNull char getFromRest(final int index) {
        return (char) ARRAY_ACCESS.get(index - definedAsValues, (char[]) rest);
    }

    protected final @NotNull char getVolatileFromRest(final int index) {
        return (char) ARRAY_ACCESS.getVolatile(index - definedAsValues, (char[]) rest);
    }

    public abstract char get(final int index);

    public abstract char getUnsafe(final int index);

    public abstract char getVolatile(final int index);

    public static  ImmutableTabledArrayChar getInstance(
        final boolean checked, final int length, final @NotNull char ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Char.getInstance(checked, length, values);
            case 1:
                return ImmutableTabledArray0001Char.getInstance(checked, length, values);
            case 2: 
                return ImmutableTabledArray0002Char.getInstance(checked, length, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Char.getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Char.getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Char.getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Char.getInstance(checked, length, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Char.getInstance(checked, length, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Char.getInstance(checked, length, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Char.getInstance(checked, length, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Char.getInstance(checked, length, values);
