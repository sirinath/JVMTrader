...
public abstract class MutableTabledArrayBoolean extends ImmutableTabledArrayBoolean {
    protected MutableTabledArrayBoolean(final boolean checked, final int definedAsValues, final boolean ... values) {
        super(checked, definedAsValues, values);
    }


    public abstract void put(int index, boolean value);

    protected final void putToRest(int index, boolean value) {
        ARRAY_ACCESS.put(rest, index - definedAsValues, value);
    }

    public static  MutableTabledArrayBoolean getInstance(final boolean checked, final int length, final boolean ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000Boolean.getInstance(checked, values);
            case 1:
                return MutableTabledArray0001Boolean.getInstance(checked, values);
            case 2: 
                return MutableTabledArray0002Boolean.getInstance(checked, values);

            case 3: case 4: 
                return MutableTabledArray0004Boolean.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008Boolean.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016Boolean.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032Boolean.getInstance(checked, values);
            ...
            case 64: 
                return MutableTabledArray0064Boolean.getInstance(checked, values);
            ...
            case 128: 
                return MutableTabledArray0128Boolean.getInstance(checked, values);
            ...
            case 256: 
                return MutableTabledArray0256Boolean.getInstance(checked, values);
            ...
            case 512: 
                return MutableTabledArray0512Boolean.getInstance(checked, values);
            ...
            case 1024: 
                return MutableTabledArray1024Boolean.getInstance(checked, values);
            ...
            case 2048: 
                return MutableTabledArray2048Boolean.getInstance(checked, values);
            ...
            case 4096: 
                return MutableTabledArray4096Boolean.getInstance(checked, values);
            ...
            case 8192: 
                return MutableTabledArray8192Boolean.getInstance(checked, values);
