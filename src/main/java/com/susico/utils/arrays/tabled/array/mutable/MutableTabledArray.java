...
public abstract class MutableTabledArray<T> extends ImmutableTabledArray<T> {
    protected MutableTabledArray(final boolean checked, final int definedAsValues, final int length, final @NotNull T ... values) {
        super(checked, definedAsValues, length, values);
    }

    protected final void putToRest(final int index, final @NotNull T value) {
        ARRAY_ACCESS.<T>put(index - definedAsValues, (T[]) rest, (T) value);
    }

    protected final void putVolatileToRest(final int index, final @NotNull T value) {
        ARRAY_ACCESS.<T>putVolatile(index - definedAsValues, (T[]) rest, (T) value);
    }

    public abstract void put(final int index, final @NotNull T value);

    public abstract void putUnsafe(final int index, final @NotNull T value);

    public abstract void putVolatile(final int index, final @NotNull T value);

    protected final void putOrderedToRest(final int index, final @NotNull T value) {
        ARRAY_ACCESS.<T>putOrdered(index - definedAsValues, (T[]) rest, (T) value);
    }

    protected final @NotNull T getAndSetFromRest(final int index, final @NotNull T value) {
        return ARRAY_ACCESS.<T>getAndSet(index - definedAsValues, (T[]) rest, (T) value);
    }

    public abstract void putOrdered(final int index, final @NotNull T value);

    public abstract T getAndSet(final int index, final @NotNull T value);

    protected final boolean compareAndSwapFromRest(final int index, final @NotNull T expected, final @NotNull T value) {
        return ARRAY_ACCESS.<T>compareAndSwap(
            index - definedAsValues, (T[]) rest, (T) expected, (T) value);
    }

    public abstract boolean compareAndSwap(final int index, final @NotNull T expected, final @NotNull T value);

    protected final @NotNull T updateAndGetFromRest(final int index, final @NotNull BiOpObject<T> op, final @NotNull T value) {
        return ARRAY_ACCESS.<T>updateAndGet(index - definedAsValues, (T[]) rest, op, value);
    }

    protected final @NotNull T getAndUpdateFromRest(final int index, final @NotNull BiOpObject<T> op, final @NotNull T value) {
        return ARRAY_ACCESS.<T>getAndUpdate(index - definedAsValues, (T[]) rest, op, value);
    }

    public abstract T updateAndGet(final int index, final @NotNull BiOpObject<T> op, final @NotNull T value);

    public abstract T getAndUpdate(final int index, final @NotNull BiOpObject<T> op, final @NotNull T value);

    protected final @NotNull T updateAndGetFromRest(final int index, final @NotNull UnaryOpObject<T> op) {
        return ARRAY_ACCESS.<T>updateAndGet(index - definedAsValues, (T[]) rest, op);
    }

    protected final @NotNull T getAndUpdateFromRest(final int index, final @NotNull UnaryOpObject<T> op) {
        return ARRAY_ACCESS.<T>getAndUpdate(index - definedAsValues, (T[]) rest, op);
    }

    public abstract T updateAndGet(final int index, final @NotNull UnaryOpObject<T> op);

    public abstract T getAndUpdate(final int index, final @NotNull UnaryOpObject<T> op);

    protected final @NotNull T updateAndGetFromRest(final int index, final @NotNull MultiOpObject<T> op, final @NotNull T ... value) {
        return ARRAY_ACCESS.<T>updateAndGet(index - definedAsValues, (T[]) rest, op, value);
    }

    protected final @NotNull T getAndUpdateFromRest(final int index, final @NotNull MultiOpObject<T> op, final @NotNull T ... value) {
        return ARRAY_ACCESS.<T>getAndUpdate(index - definedAsValues, (T[]) rest, op, value);
    }

    public abstract T updateAndGet(final int index, final @NotNull MultiOpObject<T> op, final @NotNull T ... value);

    public abstract T getAndUpdate(final int index, final @NotNull MultiOpObject<T> op, final @NotNull T ... value);

    public static <T> MutableTabledArray<T> getInstance(
        final boolean checked, final int length, final @NotNull T ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000.<T>getInstance(checked, length, values);
            case 1:
                return MutableTabledArray0001.<T>getInstance(checked, length, values);
            case 2: 
                return MutableTabledArray0002.<T>getInstance(checked, length, values);

            case 3: case 4: 
                return MutableTabledArray0004.<T>getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008.<T>getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016.<T>getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032.<T>getInstance(checked, length, values);
            ...
            case 64: 
                return MutableTabledArray0064.<T>getInstance(checked, length, values);
            ...
            case 128: 
                return MutableTabledArray0128.<T>getInstance(checked, length, values);
            ...
            case 256: 
                return MutableTabledArray0256.<T>getInstance(checked, length, values);
            ...
            case 512: 
                return MutableTabledArray0512.<T>getInstance(checked, length, values);
