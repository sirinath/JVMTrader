...
public abstract class MutableTabledArrayBoolean extends ImmutableTabledArrayBoolean {
    protected MutableTabledArrayBoolean(final boolean checked, final int definedAsValues, final int length, final boolean ... values) {
        super(checked, definedAsValues, length, values);
    }


    public abstract void put(final int index, final boolean value);

    protected final void putToRest(final int index, final boolean value) {
    ...
    public static  MutableTabledArrayBoolean getInstance(final boolean checked, final int length, final boolean ... values) {
        switch (length) {
            ...
            case 1024: 
                return MutableTabledArray1024Boolean.getInstance(checked, length, values);
