...
public abstract class ImmutableTabledArray0001Long extends ImmutableTabledArray0000Long {
    ...
    protected ImmutableTabledArray0001Long(final boolean checked, final int length, final long ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0001Long(final boolean checked, final int definedAsValues, final int length, final long ... values) {
    ...
    public static  ImmutableTabledArray0001Long getInstance(final boolean checked, final int length, final long ... values) {
