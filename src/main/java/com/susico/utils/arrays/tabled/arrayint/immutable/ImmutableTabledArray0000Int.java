...
public abstract class ImmutableTabledArray0000Int
    extends ImmutableTabledArrayInt {
    protected ImmutableTabledArray0000Int(final boolean checked, final int length, final @NotNull int ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0000Int(
    ...
    public static  ImmutableTabledArray0000Int getInstance(
