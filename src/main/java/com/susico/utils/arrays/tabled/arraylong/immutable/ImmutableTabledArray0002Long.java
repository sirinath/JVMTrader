...
public abstract class ImmutableTabledArray0002Long extends ImmutableTabledArray0001Long {
    ...
    protected ImmutableTabledArray0002Long(final boolean checked, final int length, final long ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0002Long(final boolean checked, final int definedAsValues, final int length, final long ... values) {
    ...
    public static  ImmutableTabledArray0002Long getInstance(final boolean checked, final int length, final long ... values) {
