...
public abstract class MutableTabledArray0002Int extends MutableTabledArray0001Int {
    ...
    protected MutableTabledArray0002Int(final boolean checked, final int length, final int ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0002Int(final boolean checked, final int definedAsValues, final int length, final int ... values) {
    ...
    public static  MutableTabledArray0002Int getInstance(final boolean checked, final int length, final int ... values) {
