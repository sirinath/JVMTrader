...
public abstract class MutableTabledArray0016Char extends MutableTabledArray0008Char {
    ...
    public final void setValue0008(final char value0008) {
        this.value0008 = value0008;
    }
    
    public final void setValue0009(final char value0009) {
        this.value0009 = value0009;
    }
    
    public final void setValue0010(final char value0010) {
        this.value0010 = value0010;
    }
    
    public final void setValue0011(final char value0011) {
        this.value0011 = value0011;
    }
    
    public final void setValue0012(final char value0012) {
        this.value0012 = value0012;
    }
    
    public final void setValue0013(final char value0013) {
        this.value0013 = value0013;
    }
    
    public final void setValue0014(final char value0014) {
        this.value0014 = value0014;
    }
    
    public final void setValue0015(final char value0015) {
        this.value0015 = value0015;
    }
    
    protected MutableTabledArray0016Char(final boolean checked, final int length, final char ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0016Char(final boolean checked, final int definedAsValues, final int length, final char ... values) {
    ...
    public static  MutableTabledArray0016Char getInstance(final boolean checked, final int length, final char ... values) {
