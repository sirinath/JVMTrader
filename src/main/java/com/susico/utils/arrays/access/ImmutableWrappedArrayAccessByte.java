...
public final class ImmutableWrappedArrayAccessByte {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessByte.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessByte.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessByte.class, "inc");

    public ImmutableWrappedArrayAccessByte(final boolean SAFE, final byte[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public static  ImmutableWrappedArrayAccessByte checked(
        final boolean checked, final @NotNull byte[] array) {
        return new ImmutableWrappedArrayAccessByte(checked, array);
    }
    ...
    public static  ImmutableWrappedArrayAccessByte unchecked(
        final @NotNull byte[] array) {
