...
public abstract class ImmutableTabledArray0016Char extends ImmutableTabledArray0008Char {
    ...
    protected ImmutableTabledArray0016Char(final boolean checked, final int length, final char ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0016Char(final boolean checked, final int definedAsValues, final int length, final char ... values) {
    ...
    public static  ImmutableTabledArray0016Char getInstance(final boolean checked, final int length, final char ... values) {
