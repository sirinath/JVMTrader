...
public abstract class ImmutableTabledArray0004<T> extends ImmutableTabledArray0002<T> {
    ...
    protected ImmutableTabledArray0004(final boolean checked, final int length, final T ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0004(final boolean checked, final int definedAsValues, final int length, final T ... values) {
    ...
    public static <T> ImmutableTabledArray0004<T> getInstance(final boolean checked, final int length, final T ... values) {
