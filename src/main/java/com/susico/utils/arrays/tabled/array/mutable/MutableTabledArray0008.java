...
public abstract class MutableTabledArray0008<T> extends MutableTabledArray0004<T> {
    ...
    protected MutableTabledArray0008(final boolean checked, final T ... values) {
        this(checked, 0, values);
    }

    protected MutableTabledArray0008(final boolean checked, final int definedAsValues, final T ... values) {
    ...
    public static <T> MutableTabledArray0008<T> getInstance(final boolean checked, final T ... values) {
        return new MutableTabledArray0008<T>(checked, values) {
