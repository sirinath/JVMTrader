...
public abstract class MutableTabledArray0000Short extends MutableTabledArrayShort {
    protected MutableTabledArray0000Short(final boolean checked, final int length, final @NotNull short ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0000Short(
    ...
    public static  MutableTabledArray0000Short getInstance(
