...
public abstract class MutableTabledArrayByte extends ImmutableTabledArrayByte {
    protected MutableTabledArrayByte(final boolean checked, final int definedAsValues, final int length, final byte ... values) {
        super(checked, definedAsValues, length, values);
    }


    public abstract void put(final int index, final byte value);

    protected final void putToRest(final int index, final byte value) {
    ...
    public static  MutableTabledArrayByte getInstance(final boolean checked, final int length, final byte ... values) {
        switch (length) {
            ...
            case 1024: 
                return MutableTabledArray1024Byte.getInstance(checked, length, values);
