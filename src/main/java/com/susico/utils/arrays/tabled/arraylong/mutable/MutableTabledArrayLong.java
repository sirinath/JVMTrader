...
public abstract class MutableTabledArrayLong extends ImmutableTabledArrayLong {
    protected MutableTabledArrayLong(final boolean checked, final int definedAsValues, final int length, final long ... values) {
        super(checked, definedAsValues, length, values);
    }


    public abstract void put(final int index, final long value);

    protected final void putToRest(final int index, final long value) {
    ...
    public static  MutableTabledArrayLong getInstance(final boolean checked, final int length, final long ... values) {
        switch (length) {
            ...
            case 1024: 
                return MutableTabledArray1024Long.getInstance(checked, length, values);
