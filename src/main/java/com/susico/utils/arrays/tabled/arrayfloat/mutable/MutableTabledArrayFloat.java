...
public abstract class MutableTabledArrayFloat extends ImmutableTabledArrayFloat {
    protected MutableTabledArrayFloat(final boolean checked, final int definedAsValues, final int length, final @NotNull float ... values) {
        super(checked, definedAsValues, length, values);
    }

    protected final void putToRest(final int index, final @NotNull float value) {
        ARRAY_ACCESS.put(index - definedAsValues, (float[]) rest, (float) value);
    }

    protected final void putVolatileToRest(final int index, final @NotNull float value) {
        ARRAY_ACCESS.putVolatile(index - definedAsValues, (float[]) rest, (float) value);
    }

    public abstract void put(final int index, final @NotNull float value);

    public abstract void putUnsafe(final int index, final @NotNull float value);

    public abstract void putVolatile(final int index, final @NotNull float value);

    protected final void putOrderedToRest(final int index, final @NotNull float value) {
        ARRAY_ACCESS.putOrdered(index - definedAsValues, (float[]) rest, (float) value);
    }

    protected final @NotNull float getAndSetFromRest(final int index, final @NotNull float value) {
        return ARRAY_ACCESS.getAndSet(index - definedAsValues, (float[]) rest, (float) value);
    }

    public abstract void putOrdered(final int index, final @NotNull float value);

    public abstract float getAndSet(final int index, final @NotNull float value);

    protected final boolean compareAndSwapFromRest(final int index, final @NotNull float expected, final @NotNull float value) {
        return ARRAY_ACCESS.compareAndSwap(
            index - definedAsValues, (float[]) rest, (float) expected, (float) value);
    }

    public abstract boolean compareAndSwap(final int index, final @NotNull float expected, final @NotNull float value);

    protected final @NotNull float updateAndGetFromRest(final int index, final @NotNull BiOpFloat op, final @NotNull float value) {
        return ARRAY_ACCESS.updateAndGet(index - definedAsValues, (float[]) rest, op, value);
    }

    protected final @NotNull float getAndUpdateFromRest(final int index, final @NotNull BiOpFloat op, final @NotNull float value) {
        return ARRAY_ACCESS.getAndUpdate(index - definedAsValues, (float[]) rest, op, value);
    }

    public abstract float updateAndGet(final int index, final @NotNull BiOpFloat op, final @NotNull float value);

    public abstract float getAndUpdate(final int index, final @NotNull BiOpFloat op, final @NotNull float value);

    protected final @NotNull float updateAndGetFromRest(final int index, final @NotNull UnaryOpFloat op) {
        return ARRAY_ACCESS.updateAndGet(index - definedAsValues, (float[]) rest, op);
    }

    protected final @NotNull float getAndUpdateFromRest(final int index, final @NotNull UnaryOpFloat op) {
        return ARRAY_ACCESS.getAndUpdate(index - definedAsValues, (float[]) rest, op);
    }

    public abstract float updateAndGet(final int index, final @NotNull UnaryOpFloat op);

    public abstract float getAndUpdate(final int index, final @NotNull UnaryOpFloat op);

    protected final @NotNull float updateAndGetFromRest(final int index, final @NotNull MultiOpFloat op, final @NotNull float ... value) {
        return ARRAY_ACCESS.updateAndGet(index - definedAsValues, (float[]) rest, op, value);
    }

    protected final @NotNull float getAndUpdateFromRest(final int index, final @NotNull MultiOpFloat op, final @NotNull float ... value) {
        return ARRAY_ACCESS.getAndUpdate(index - definedAsValues, (float[]) rest, op, value);
    }

    public abstract float updateAndGet(final int index, final @NotNull MultiOpFloat op, final @NotNull float ... value);

    public abstract float getAndUpdate(final int index, final @NotNull MultiOpFloat op, final @NotNull float ... value);

    public static  MutableTabledArrayFloat getInstance(
