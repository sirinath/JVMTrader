...
public abstract class ImmutableTabledArray0008Char extends ImmutableTabledArray0004Char {
    ...
    protected ImmutableTabledArray0008Char(final boolean checked, final char ... values) {
        this(checked, 0, values);
    }

    protected ImmutableTabledArray0008Char(final boolean checked, final int definedAsValues, final char ... values) {
    ...
    public static  ImmutableTabledArray0008Char getInstance(final boolean checked, final char ... values) {
        return new ImmutableTabledArray0008Char(checked, values) {
