...
public abstract class ImmutableTabledArrayLong extends TabledArray {
    ...
    protected ImmutableTabledArrayLong(final boolean checked, final int definedAsValues, final long ... values) {
        super(checked, definedAsValues, values.length);
        this.rest = new long[length > definedAsValues ? length - definedAsValues : 0];
    ...
    protected final long getFromRest(int index) {
        return (long) ARRAY_ACCESS.get(rest, index - definedAsValues);
    }

    public static  ImmutableTabledArrayLong getInstance(final boolean checked, final int length, final long ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Long.getInstance(checked, values);
            case 1:
                return ImmutableTabledArray0001Long.getInstance(checked, values);
            case 2: 
                return ImmutableTabledArray0002Long.getInstance(checked, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Long.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Long.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Long.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Long.getInstance(checked, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Long.getInstance(checked, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Long.getInstance(checked, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Long.getInstance(checked, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Long.getInstance(checked, values);
            ...
            case 1024: 
                return ImmutableTabledArray1024Long.getInstance(checked, values);
            ...
            case 2048: 
                return ImmutableTabledArray2048Long.getInstance(checked, values);
            ...
            case 4096: 
                return ImmutableTabledArray4096Long.getInstance(checked, values);
            ...
            case 8192: 
                return ImmutableTabledArray8192Long.getInstance(checked, values);
