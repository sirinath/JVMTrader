...
public final class ImmutableWrappedArrayAccessFloat {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessFloat.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessFloat.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessFloat.class, "inc");

    public ImmutableWrappedArrayAccessFloat(final boolean SAFE, final float[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public static  ImmutableWrappedArrayAccessFloat checked(
        final boolean checked, final @NotNull float[] array) {
        return new ImmutableWrappedArrayAccessFloat(checked, array);
    }
    ...
    public static  ImmutableWrappedArrayAccessFloat unchecked(
        final @NotNull float[] array) {
