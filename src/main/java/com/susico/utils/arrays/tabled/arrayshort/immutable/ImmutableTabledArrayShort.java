...
public abstract class ImmutableTabledArrayShort extends TabledArray {
    protected final short[] rest;
    protected final int actualLength;

    protected ImmutableTabledArrayShort(final boolean checked, final int definedAsValues, final int length, final @NotNull short ... values) {
        super(checked, definedAsValues, length);

        final int effectiveLength = Math.max(length, values.length);
        rest = new short[effectiveLength > definedAsValues ? effectiveLength - definedAsValues : 0];
    ...
    protected final @NotNull short getFromRest(final int index) {
        return (short) ARRAY_ACCESS.get(index - definedAsValues, (short[]) rest);
    }

    protected final @NotNull short getVolatileFromRest(final int index) {
        return (short) ARRAY_ACCESS.getVolatile(index - definedAsValues, (short[]) rest);
    }

    public abstract short get(final int index);

    public abstract short getUnsafe(final int index);

    public abstract short getVolatile(final int index);

    public static  ImmutableTabledArrayShort getInstance(
        final boolean checked, final int length, final @NotNull short ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Short.getInstance(checked, length, values);
            case 1:
                return ImmutableTabledArray0001Short.getInstance(checked, length, values);
            case 2: 
                return ImmutableTabledArray0002Short.getInstance(checked, length, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Short.getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Short.getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Short.getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Short.getInstance(checked, length, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Short.getInstance(checked, length, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Short.getInstance(checked, length, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Short.getInstance(checked, length, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Short.getInstance(checked, length, values);
