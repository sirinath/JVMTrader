...
public abstract class MutableTabledArray0002Byte extends MutableTabledArray0001Byte {
    ...
    protected MutableTabledArray0002Byte(final boolean checked, final byte ... values) {
        this(checked, 0, values);
    }

    protected MutableTabledArray0002Byte(final boolean checked, final int definedAsValues, final byte ... values) {
    ...
    public static  MutableTabledArray0002Byte getInstance(final boolean checked, final byte ... values) {
        return new MutableTabledArray0002Byte(checked, values) {
