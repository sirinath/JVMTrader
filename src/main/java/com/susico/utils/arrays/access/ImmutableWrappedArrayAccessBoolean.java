...
public final class ImmutableWrappedArrayAccessBoolean {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessBoolean.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessBoolean.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessBoolean.class, "inc");

    public ImmutableWrappedArrayAccessBoolean(final boolean SAFE, final boolean[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public static  ImmutableWrappedArrayAccessBoolean checked(
        final boolean checked, final @NotNull boolean[] array) {
        return new ImmutableWrappedArrayAccessBoolean(checked, array);
    }
    ...
    public static  ImmutableWrappedArrayAccessBoolean unchecked(
        final @NotNull boolean[] array) {
