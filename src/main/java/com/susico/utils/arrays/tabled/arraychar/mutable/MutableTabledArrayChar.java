...
public abstract class MutableTabledArrayChar extends ImmutableTabledArrayChar {
    protected MutableTabledArrayChar(final boolean checked, final int definedAsValues, final char ... values) {
        super(checked, definedAsValues, values);
    }


    public abstract void put(int index, char value);

    protected final void putToRest(int index, char value) {
        ARRAY_ACCESS.put(rest, index - definedAsValues, value);
    }

    public static  MutableTabledArrayChar getInstance(final boolean checked, final int length, final char ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000Char.getInstance(checked, values);
            case 1:
                return MutableTabledArray0001Char.getInstance(checked, values);
            case 2: 
                return MutableTabledArray0002Char.getInstance(checked, values);

            case 3: case 4: 
                return MutableTabledArray0004Char.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008Char.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016Char.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032Char.getInstance(checked, values);
            ...
            case 64: 
                return MutableTabledArray0064Char.getInstance(checked, values);
            ...
            case 128: 
                return MutableTabledArray0128Char.getInstance(checked, values);
            ...
            case 256: 
                return MutableTabledArray0256Char.getInstance(checked, values);
            ...
            case 512: 
                return MutableTabledArray0512Char.getInstance(checked, values);
            ...
            case 1024: 
                return MutableTabledArray1024Char.getInstance(checked, values);
            ...
            case 2048: 
                return MutableTabledArray2048Char.getInstance(checked, values);
            ...
            case 4096: 
                return MutableTabledArray4096Char.getInstance(checked, values);
            ...
            case 8192: 
                return MutableTabledArray8192Char.getInstance(checked, values);
