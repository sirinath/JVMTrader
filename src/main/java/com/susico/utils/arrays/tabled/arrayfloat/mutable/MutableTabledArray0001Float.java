...
public abstract class MutableTabledArray0001Float extends MutableTabledArray0000Float {
    ...
    protected MutableTabledArray0001Float(final boolean checked, final int length, final float ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0001Float(final boolean checked, final int definedAsValues, final int length, final float ... values) {
    ...
    public static  MutableTabledArray0001Float getInstance(final boolean checked, final int length, final float ... values) {
