...
public abstract class ImmutableTabledArray0000Long
    extends ImmutableTabledArrayLong {
    protected ImmutableTabledArray0000Long(final boolean checked, final int length, final @NotNull long ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0000Long(
    ...
    public static  ImmutableTabledArray0000Long getInstance(
