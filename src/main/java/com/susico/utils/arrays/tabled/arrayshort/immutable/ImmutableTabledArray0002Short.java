...
public abstract class ImmutableTabledArray0002Short extends ImmutableTabledArray0001Short {
    ...
    protected ImmutableTabledArray0002Short(final boolean checked, final int length, final short ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0002Short(final boolean checked, final int definedAsValues, final int length, final short ... values) {
    ...
    public static  ImmutableTabledArray0002Short getInstance(final boolean checked, final int length, final short ... values) {
