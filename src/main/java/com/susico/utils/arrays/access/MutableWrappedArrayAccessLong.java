...
public final class MutableWrappedArrayAccessLong {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessLong.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessLong.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessLong.class, "inc");

    public MutableWrappedArrayAccessLong(final boolean SAFE, final long[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessLong wrap(final @NotNull long[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessLong checked(
        final boolean checked, final @NotNull long[] array) {
        return new MutableWrappedArrayAccessLong(checked, array);
    }

    public static  MutableWrappedArrayAccessLong checked(
        final @NotNull long[] array) {
        return checked(true, array);
    }

    public static  MutableWrappedArrayAccessLong unchecked(
        final @NotNull long[] array) {
    ...
    public final @NotNull long[] copy(final @NotNull long[] destination) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final int index, final int offset, final @NotNull long ... buffer) {
    ...
    public final @NotNull long[] put(final int index, final @NotNull long value) {
    ...
    public static @NotNull  long getVolatile(final boolean SAFE, final int index, final @NotNull long ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
    ...
    public final @NotNull long[] copy(
        final int index, final @NotNull long ... source) {
    ...
    public static @NotNull  long[] copy(
        final boolean SAFE, final int index, final @NotNull long[] destination,
        final @NotNull long ... source) {
        if (SAFE)
    ...
    public final @NotNull long[] copyAtIndex(
    ...
    public final @NotNull  long[] copy(
        final int length, final int indexDestination,
        final @NotNull long[] destination,
        final int indexSource, final @NotNull long ... source) {
    ...
    public final @NotNull long getAndSet(
        final int index, final @NotNull long value) {
        return (long) getAndSet(index, buffer, value);
    }
    ...
    public final @NotNull long getAndUpdate(
        ...
        return (long) getAndUpdate(index, buffer, op, value);
    }
    ...
    public static @NotNull  long getAndUpdate(
        ...
        final @NotNull BiOpLong op, final @NotNull long value) {
        checkIndexIfSafeOn(SAFE, index, buffer);
    ...
    public final @NotNull  long updateAndGet(
        final int index, final @NotNull long[] buffer,
        final @NotNull BiOpLong op, final @NotNull long value) {
    ...
    public static @NotNull  long updateAndGet(
        final boolean SAFE, final int index, final @NotNull long[] buffer,
        final BiOpLong op, final @NotNull long value) {
        checkIndexIfSafeOn(SAFE, index, buffer);
    ...
    public final @NotNull long getAndUpdate(
        ...
        return (long) getAndUpdate(index, buffer, op);
    }
    ...
    public static @NotNull  long updateAndGet(
        final boolean SAFE, final int index, final @NotNull long[] buffer,
        final MultiOpLong op, final @NotNull long ... value) {
        checkIndexIfSafeOn(SAFE, index, buffer);
    ...
    public final  void checkIndexIfSafeOnWithOffset(final long index, final long offset, final @NotNull long ... buffer) {
        checkIndexIfSafeOnWithOffset(this.SAFE, index, offset, buffer);
    }
    ...
    public final @NotNull long get(final long index) {
        return get(index, buffer);
    }
    ...
    public final @NotNull long[] put(final long index, final @NotNull long value) {
        return put(index, buffer, value);
    }
    ...
    public final @NotNull long getVolatile(final long index) {
        return getVolatile(index, buffer);
    }
    ...
    public static @NotNull  long getVolatile(final boolean SAFE, final long index, final @NotNull long ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
            return (long) UNSAFE.getLongVolatile(buffer,
    ...
    public final @NotNull long[] putVolatile(
        final long index, final @NotNull long value) {
        return putVolatile(index, buffer, value);
    }
    ...
    public final @NotNull long[] copy(
        final long index, final @NotNull long ... source) {
        return copy(index, buffer, source);
    }
    ...
    public static @NotNull  long[] copy(
        final boolean SAFE, final long index, final @NotNull long[] destination,
        final @NotNull long ... source) {
        if (SAFE)
            System.arraycopy(source, 0, destination, (int) index, source.length);
        else
    ...
    public final boolean compareAndSwap(
        final long index, final @NotNull long expected, final @NotNull long value) {
        return compareAndSwap(index, buffer, expected, value);
    }
    ...
    public final @NotNull long getAndUpdate(
        final long index, final @NotNull BiOpLong op, final @NotNull long value) {
        return (long) getAndUpdate(index, buffer, op, value);
    }
    ...
    public final @NotNull  long updateAndGet(
        final long index, final @NotNull long[] buffer,
        final @NotNull BiOpLong op, final @NotNull long value) {
        return updateAndGet(this.SAFE, index, buffer, op, value);
    }
    ...
    public final @NotNull long getAndUpdate(
        final long index, final @NotNull UnaryOpLong op) {
        return (long) getAndUpdate(index, buffer, op);
    }
    ...
    public final @NotNull long getAndUpdate(
        final long index, final @NotNull MultiOpLong op, final @NotNull long ... value) {
        return (long) getAndUpdate(index, buffer, op, value);
    }
