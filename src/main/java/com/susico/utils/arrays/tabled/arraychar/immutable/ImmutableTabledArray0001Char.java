...
public abstract class ImmutableTabledArray0001Char extends ImmutableTabledArray0000Char {
    ...
    protected ImmutableTabledArray0001Char(final boolean checked, final int length, final char ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0001Char(final boolean checked, final int definedAsValues, final int length, final char ... values) {
    ...
    public static  ImmutableTabledArray0001Char getInstance(final boolean checked, final int length, final char ... values) {
