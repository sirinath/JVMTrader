...
public abstract class ImmutableTabledArrayLong extends TabledArray {
    protected final long[] rest;
    protected final int actualLength;

    protected ImmutableTabledArrayLong(final boolean checked, final int definedAsValues, final int length, final @NotNull long ... values) {
        super(checked, definedAsValues, length);

        final int effectiveLength = Math.max(length, values.length);
        rest = new long[effectiveLength > definedAsValues ? effectiveLength - definedAsValues : 0];
    ...
    protected final @NotNull long getFromRest(final int index) {
        return (long) ARRAY_ACCESS.get(index - definedAsValues, (long[]) rest);
    }

    protected final @NotNull long getVolatileFromRest(final int index) {
        return (long) ARRAY_ACCESS.getVolatile(index - definedAsValues, (long[]) rest);
    }

    public abstract long get(final int index);

    public abstract long getUnsafe(final int index);

    public abstract long getVolatile(final int index);

    public static  ImmutableTabledArrayLong getInstance(
        final boolean checked, final int length, final @NotNull long ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000Long.getInstance(checked, length, values);
            case 1:
                return ImmutableTabledArray0001Long.getInstance(checked, length, values);
            case 2: 
                return ImmutableTabledArray0002Long.getInstance(checked, length, values);

            case 3: case 4: 
                return ImmutableTabledArray0004Long.getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008Long.getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016Long.getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032Long.getInstance(checked, length, values);
            ...
            case 64: 
                return ImmutableTabledArray0064Long.getInstance(checked, length, values);
            ...
            case 128: 
                return ImmutableTabledArray0128Long.getInstance(checked, length, values);
            ...
            case 256: 
                return ImmutableTabledArray0256Long.getInstance(checked, length, values);
            ...
            case 512: 
                return ImmutableTabledArray0512Long.getInstance(checked, length, values);
