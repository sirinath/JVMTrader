...
public abstract class ImmutableTabledArray0002Char extends ImmutableTabledArray0001Char {
    ...
    protected ImmutableTabledArray0002Char(final boolean checked, final int length, final char ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0002Char(final boolean checked, final int definedAsValues, final int length, final char ... values) {
    ...
    public static  ImmutableTabledArray0002Char getInstance(final boolean checked, final int length, final char ... values) {
