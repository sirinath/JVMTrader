...
public abstract class MutableTabledArrayChar extends ImmutableTabledArrayChar {
    protected MutableTabledArrayChar(final boolean checked, final int definedAsValues, final int length, final char ... values) {
        super(checked, definedAsValues, length, values);
    }


    public abstract void put(final int index, final char value);

    protected final void putToRest(final int index, final char value) {
    ...
    public static  MutableTabledArrayChar getInstance(final boolean checked, final int length, final char ... values) {
        switch (length) {
            ...
            case 1024: 
                return MutableTabledArray1024Char.getInstance(checked, length, values);
