...
public final class ImmutableWrappedArrayAccessLong {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessLong.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessLong.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(ImmutableWrappedArrayAccessLong.class, "inc");

    public ImmutableWrappedArrayAccessLong(final boolean SAFE, final long[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public static  ImmutableWrappedArrayAccessLong checked(
        final boolean checked, final @NotNull long[] array) {
        return new ImmutableWrappedArrayAccessLong(checked, array);
    }
    ...
    public static  ImmutableWrappedArrayAccessLong unchecked(
        final @NotNull long[] array) {
