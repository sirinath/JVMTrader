...
public final class MutableBoolean extends Number
     ...
     * Value
     */
    @Contended private  boolean value;

    /**
     * @param i Parameter
     */
    public MutableBoolean(final @NotNull boolean i) {
        value = i;
    }

    @Override
    public final MutableBoolean clone() throws CloneNotSupportedException {
    ...
    public final void setValue(final @NotNull boolean value) {
        this.value = value;
    }

    public final void set(final @NotNull boolean value) {
        this.value = value;
    }

    public final void setValueVolatile(final @NotNull boolean value) {
