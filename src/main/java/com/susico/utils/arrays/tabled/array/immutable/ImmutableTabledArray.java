...
public abstract class ImmutableTabledArray<T> extends TabledArray {
    protected final Object[] rest;

    protected ImmutableTabledArray(final boolean checked, final int definedAsValues, final int length, final T ... values) {
        super(checked, definedAsValues, length);

        final int effectiveLength = Math.max(length, values.length)
        this.rest = new Object[effectiveLength > definedAsValues ? effectiveLength - definedAsValues : 0];
    ...
    protected final T getFromRest(final int index) {
        return (T) ARRAY_ACCESS.get(rest, index - definedAsValues);
    }

    public static <T> ImmutableTabledArray<T> getInstance(final boolean checked, final int length, final T ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000.<T>getInstance(checked, length, values);
            case 1:
                return ImmutableTabledArray0001.<T>getInstance(checked, length, values);
            case 2: 
                return ImmutableTabledArray0002.<T>getInstance(checked, length, values);

            case 3: case 4: 
                return ImmutableTabledArray0004.<T>getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008.<T>getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016.<T>getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032.<T>getInstance(checked, length, values);
            ...
            case 64: 
                return ImmutableTabledArray0064.<T>getInstance(checked, length, values);
            ...
            case 128: 
                return ImmutableTabledArray0128.<T>getInstance(checked, length, values);
            ...
            case 256: 
                return ImmutableTabledArray0256.<T>getInstance(checked, length, values);
            ...
            case 512: 
                return ImmutableTabledArray0512.<T>getInstance(checked, length, values);
            ...
            case 1024: 
                return ImmutableTabledArray1024.<T>getInstance(checked, length, values);


            default:
                return ImmutableTabledArray1024.getInstance(checked, length, values);
        }
    }
}