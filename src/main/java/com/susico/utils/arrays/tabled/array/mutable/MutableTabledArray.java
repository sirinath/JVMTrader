...
public abstract class MutableTabledArray<T> extends ImmutableTabledArray<T> {
    ...
    public static <T> MutableTabledArray<T> getInstance(final boolean checked, final int length, final T ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000.<T>getInstance(checked, values);
            case 1:
                return MutableTabledArray0001.<T>getInstance(checked, values);
            case 2: 
                return MutableTabledArray0002.<T>getInstance(checked, values);

            case 3: case 4: 
                return MutableTabledArray0004.<T>getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008.<T>getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016.<T>getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032.<T>getInstance(checked, values);
            ...
            case 64: 
                return MutableTabledArray0064.<T>getInstance(checked, values);
            ...
            case 128: 
                return MutableTabledArray0128.<T>getInstance(checked, values);
            ...
            case 256: 
                return MutableTabledArray0256.<T>getInstance(checked, values);
            ...
            case 512: 
                return MutableTabledArray0512.<T>getInstance(checked, values);
            ...
            case 1024: 
                return MutableTabledArray1024.<T>getInstance(checked, values);
