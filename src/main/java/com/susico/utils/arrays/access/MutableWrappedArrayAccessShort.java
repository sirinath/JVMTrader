...
public final class MutableWrappedArrayAccessShort {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessShort.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessShort.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessShort.class, "inc");

    public MutableWrappedArrayAccessShort(final boolean SAFE, final short[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessShort wrap(final @NotNull short[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessShort checked(
        final boolean checked, final @NotNull short[] array) {
        return new MutableWrappedArrayAccessShort(checked, array);
    }

    public static  MutableWrappedArrayAccessShort checked(
        final @NotNull short[] array) {
        return checked(true, array);
    }

    public static  MutableWrappedArrayAccessShort unchecked(
        final @NotNull short[] array) {
    ...
    public final @NotNull short[] copy(final @NotNull short[] destination) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final int index, final int offset, final @NotNull short ... buffer) {
    ...
    public final @NotNull short[] put(final int index, final @NotNull short value) {
    ...
    public static @NotNull  short getVolatile(final boolean SAFE, final int index, final @NotNull short ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
    ...
    public final @NotNull short[] putVolatile(
        final int index, final @NotNull short value) {
    ...
    public final @NotNull short[] copy(
        final int index, final @NotNull short ... source) {
    ...
    public static @NotNull  short[] copy(
        final boolean SAFE, final int index, final @NotNull short[] destination,
        final @NotNull short ... source) {
        if (SAFE)
    ...
    public final @NotNull short[] copyAtIndex(
    ...
    public final @NotNull  short[] copy(
        final int length, final int indexDestination,
        final @NotNull short[] destination,
        final int indexSource, final @NotNull short ... source) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final long index, final long offset, final @NotNull short ... buffer) {
        checkIndexIfSafeOnWithOffset(this.SAFE, index, offset, buffer);
    }
    ...
    public final @NotNull short get(final long index) {
        return get(index, buffer);
    }
    ...
    public final @NotNull short[] put(final long index, final @NotNull short value) {
        return put(index, buffer, value);
    }
    ...
    public final @NotNull short getVolatile(final long index) {
        return getVolatile(index, buffer);
    }
    ...
    public static @NotNull  short getVolatile(final boolean SAFE, final long index, final @NotNull short ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
            return (short) UNSAFE.getShortVolatile(buffer,
    ...
    public final @NotNull short[] putVolatile(
        final long index, final @NotNull short value) {
        return putVolatile(index, buffer, value);
    }
    ...
    public final @NotNull short[] copy(
        final long index, final @NotNull short ... source) {
        return copy(index, buffer, source);
    }
    ...
    public static @NotNull  short[] copy(
        final boolean SAFE, final long index, final @NotNull short[] destination,
        final @NotNull short ... source) {
        if (SAFE)
            System.arraycopy(source, 0, destination, (int) index, source.length);
        else
