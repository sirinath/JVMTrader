 ...
 */
public abstract class MutableTabledArrayInt24 extends MutableTabledArrayInt16 {
    ...
    protected MutableTabledArrayInt24(final boolean checked, final int... values) {
        this(checked, 0, values);
    }

    protected MutableTabledArrayInt24(final boolean checked, final int definedAsValues, final int... values) {
