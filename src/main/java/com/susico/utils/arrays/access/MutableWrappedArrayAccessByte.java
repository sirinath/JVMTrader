...
public final class MutableWrappedArrayAccessByte {
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessByte.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessByte.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessByte.class, "inc");

    public MutableWrappedArrayAccessByte(final boolean SAFE, final byte[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessByte wrap(final @NotNull byte[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessByte checked(
        final boolean checked, final @NotNull byte[] array) {
        return new MutableWrappedArrayAccessByte(checked, array);
    }

    public static  MutableWrappedArrayAccessByte checked(
        final @NotNull byte[] array) {
        return checked(true, array);
    }

    public static  MutableWrappedArrayAccessByte unchecked(
        final @NotNull byte[] array) {
    ...
    public final @NotNull byte[] copy(final @NotNull byte[] destination) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final int index, final int offset, final @NotNull byte ... buffer) {
    ...
    public final @NotNull byte[] put(final int index, final @NotNull byte value) {
    ...
    public static @NotNull  byte getVolatile(final boolean SAFE, final int index, final @NotNull byte ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
    ...
    public final @NotNull byte[] putVolatile(
        final int index, final @NotNull byte value) {
    ...
    public final @NotNull byte[] copy(
        final int index, final @NotNull byte ... source) {
    ...
    public static @NotNull  byte[] copy(
        final boolean SAFE, final int index, final @NotNull byte[] destination,
        final @NotNull byte ... source) {
        if (SAFE)
    ...
    public final @NotNull byte[] copyAtIndex(
    ...
    public final @NotNull  byte[] copy(
        final int length, final int indexDestination,
        final @NotNull byte[] destination,
        final int indexSource, final @NotNull byte ... source) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final long index, final long offset, final @NotNull byte ... buffer) {
        checkIndexIfSafeOnWithOffset(this.SAFE, index, offset, buffer);
    }
    ...
    public final @NotNull byte get(final long index) {
        return get(index, buffer);
    }
    ...
    public final @NotNull byte[] put(final long index, final @NotNull byte value) {
        return put(index, buffer, value);
    }
    ...
    public final @NotNull byte getVolatile(final long index) {
        return getVolatile(index, buffer);
    }
    ...
    public static @NotNull  byte getVolatile(final boolean SAFE, final long index, final @NotNull byte ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
            return (byte) UNSAFE.getByteVolatile(buffer,
    ...
    public final @NotNull byte[] putVolatile(
        final long index, final @NotNull byte value) {
        return putVolatile(index, buffer, value);
    }
    ...
    public final @NotNull byte[] copy(
        final long index, final @NotNull byte ... source) {
        return copy(index, buffer, source);
    }
    ...
    public static @NotNull  byte[] copy(
        final boolean SAFE, final long index, final @NotNull byte[] destination,
        final @NotNull byte ... source) {
        if (SAFE)
            System.arraycopy(source, 0, destination, (int) index, source.length);
        else
