...
public abstract class ImmutableTabledArray0001<T> extends
    ImmutableTabledArray0000<T> {
    
    protected final static long value0000FieldOffset = UnsafeAccess.getFieldOffset(
        ImmutableTabledArray0001.class, "value0000");

    protected final @NotNull T value0000;
    ...
    protected ImmutableTabledArray0001(
    ...
    public static <T> ImmutableTabledArray0001 getInstance(
        final boolean checked, final int length, final @NotNull T ... values) {
