...
public final class MutableWrappedArrayAccessBoolean {
    protected static final Unsafe UNSAFE = UnsafeAccess.UNSAFE;

    @Contended protected final boolean SAFE;
    @Contended protected volatile boolean[] buffer;
    ...
    protected static final long indexFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessBoolean.class, "index");
    protected static final long offsetFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessBoolean.class, "offset");
    protected static final long incFieldOffset =
        UnsafeAccess.getFieldOffset(MutableWrappedArrayAccessBoolean.class, "inc");

    public MutableWrappedArrayAccessBoolean(final boolean SAFE, final boolean[] array) {
        this.SAFE = SAFE;
        this.buffer = array;
    }
    ...
    public final MutableWrappedArrayAccessBoolean wrap(final @NotNull boolean[] array) {
        try {
            while (wrapGuard)
    ...
    public static  MutableWrappedArrayAccessBoolean checked(
        final boolean checked, final @NotNull boolean[] array) {
        return new MutableWrappedArrayAccessBoolean(checked, array);
    }

    public static  MutableWrappedArrayAccessBoolean checked(
        final @NotNull boolean[] array) {
        return checked(true, array);
    }

    public static  MutableWrappedArrayAccessBoolean unchecked(
        final @NotNull boolean[] array) {
    ...
    public final @NotNull boolean[] copy(final @NotNull boolean[] destination) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final int index, final int offset, final @NotNull boolean ... buffer) {
    ...
    public final @NotNull boolean[] put(final int index, final @NotNull boolean value) {
    ...
    public static @NotNull  boolean getVolatile(final boolean SAFE, final int index, final @NotNull boolean ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
    ...
    public final @NotNull boolean[] putVolatile(
        final int index, final @NotNull boolean value) {
    ...
    public final @NotNull boolean[] copy(
        final int index, final @NotNull boolean ... source) {
    ...
    public static @NotNull  boolean[] copy(
        final boolean SAFE, final int index, final @NotNull boolean[] destination,
        final @NotNull boolean ... source) {
        if (SAFE)
    ...
    public final @NotNull boolean[] copyAtIndex(
    ...
    public final @NotNull  boolean[] copy(
        final int length, final int indexDestination,
        final @NotNull boolean[] destination,
        final int indexSource, final @NotNull boolean ... source) {
    ...
    public final  void checkIndexIfSafeOnWithOffset(final long index, final long offset, final @NotNull boolean ... buffer) {
        checkIndexIfSafeOnWithOffset(this.SAFE, index, offset, buffer);
    }
    ...
    public final @NotNull boolean get(final long index) {
        return get(index, buffer);
    }
    ...
    public final @NotNull boolean[] put(final long index, final @NotNull boolean value) {
        return put(index, buffer, value);
    }
    ...
    public final @NotNull boolean getVolatile(final long index) {
        return getVolatile(index, buffer);
    }
    ...
    public static @NotNull  boolean getVolatile(final boolean SAFE, final long index, final @NotNull boolean ... buffer) {
        if (SAFE)
            return buffer[(int) index];
        else
            return (boolean) UNSAFE.getBooleanVolatile(buffer,
    ...
    public final @NotNull boolean[] putVolatile(
        final long index, final @NotNull boolean value) {
        return putVolatile(index, buffer, value);
    }
    ...
    public final @NotNull boolean[] copy(
        final long index, final @NotNull boolean ... source) {
        return copy(index, buffer, source);
    }
    ...
    public static @NotNull  boolean[] copy(
        final boolean SAFE, final long index, final @NotNull boolean[] destination,
        final @NotNull boolean ... source) {
        if (SAFE)
            System.arraycopy(source, 0, destination, (int) index, source.length);
        else
