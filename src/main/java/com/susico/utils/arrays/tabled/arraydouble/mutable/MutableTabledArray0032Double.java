...
public abstract class MutableTabledArray0032Double extends MutableTabledArray0016Double {
    ...
    public final void setValue0016(final double value0016) {
        this.value0016 = value0016;
    }
    
    public final void setValue0017(final double value0017) {
        this.value0017 = value0017;
    }
    
    public final void setValue0018(final double value0018) {
        this.value0018 = value0018;
    }
    
    public final void setValue0019(final double value0019) {
        this.value0019 = value0019;
    }
    
    public final void setValue0020(final double value0020) {
        this.value0020 = value0020;
    }
    
    public final void setValue0021(final double value0021) {
        this.value0021 = value0021;
    }
    
    public final void setValue0022(final double value0022) {
        this.value0022 = value0022;
    }
    
    public final void setValue0023(final double value0023) {
        this.value0023 = value0023;
    }
    
    public final void setValue0024(final double value0024) {
        this.value0024 = value0024;
    }
    
    public final void setValue0025(final double value0025) {
        this.value0025 = value0025;
    }
    
    public final void setValue0026(final double value0026) {
        this.value0026 = value0026;
    }
    
    public final void setValue0027(final double value0027) {
        this.value0027 = value0027;
    }
    
    public final void setValue0028(final double value0028) {
        this.value0028 = value0028;
    }
    
    public final void setValue0029(final double value0029) {
        this.value0029 = value0029;
    }
    
    public final void setValue0030(final double value0030) {
        this.value0030 = value0030;
    }
    
    public final void setValue0031(final double value0031) {
        this.value0031 = value0031;
    }
    
    protected MutableTabledArray0032Double(final boolean checked, final int length, final double ... values) {
        this(checked, 0, length, values);
    }

    protected MutableTabledArray0032Double(final boolean checked, final int definedAsValues, final int length, final double ... values) {
    ...
    public static  MutableTabledArray0032Double getInstance(final boolean checked, final int length, final double ... values) {
