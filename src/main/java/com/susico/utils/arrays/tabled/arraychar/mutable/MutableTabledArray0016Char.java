...
public abstract class MutableTabledArray0016Char extends
    MutableTabledArray0008Char {
    ...
    public final void setValue0008(final @NotNull char value0008) {
        this.value0008 = value0008;
    }

    public final void putValue0008Unsafe(final @NotNull char value0008) {
        UNSAFE.putChar(this, value0008FieldOffset, value0008);
    }

    public final void putValue0008Volatile(final @NotNull char value0008) {
        UNSAFE.putCharVolatile(this, value0008FieldOffset, value0008);
    }
    
    public final void setValue0009(final @NotNull char value0009) {
        this.value0009 = value0009;
    }

    public final void putValue0009Unsafe(final @NotNull char value0009) {
        UNSAFE.putChar(this, value0009FieldOffset, value0009);
    }

    public final void putValue0009Volatile(final @NotNull char value0009) {
        UNSAFE.putCharVolatile(this, value0009FieldOffset, value0009);
    }
    
    public final void setValue0010(final @NotNull char value0010) {
        this.value0010 = value0010;
    }

    public final void putValue0010Unsafe(final @NotNull char value0010) {
        UNSAFE.putChar(this, value0010FieldOffset, value0010);
    }

    public final void putValue0010Volatile(final @NotNull char value0010) {
        UNSAFE.putCharVolatile(this, value0010FieldOffset, value0010);
    }
    
    public final void setValue0011(final @NotNull char value0011) {
        this.value0011 = value0011;
    }

    public final void putValue0011Unsafe(final @NotNull char value0011) {
        UNSAFE.putChar(this, value0011FieldOffset, value0011);
    }

    public final void putValue0011Volatile(final @NotNull char value0011) {
        UNSAFE.putCharVolatile(this, value0011FieldOffset, value0011);
    }
    
    public final void setValue0012(final @NotNull char value0012) {
        this.value0012 = value0012;
    }

    public final void putValue0012Unsafe(final @NotNull char value0012) {
        UNSAFE.putChar(this, value0012FieldOffset, value0012);
    }

    public final void putValue0012Volatile(final @NotNull char value0012) {
        UNSAFE.putCharVolatile(this, value0012FieldOffset, value0012);
    }
    
    public final void setValue0013(final @NotNull char value0013) {
        this.value0013 = value0013;
    }

    public final void putValue0013Unsafe(final @NotNull char value0013) {
        UNSAFE.putChar(this, value0013FieldOffset, value0013);
    }

    public final void putValue0013Volatile(final @NotNull char value0013) {
        UNSAFE.putCharVolatile(this, value0013FieldOffset, value0013);
    }
    
    public final void setValue0014(final @NotNull char value0014) {
        this.value0014 = value0014;
    }

    public final void putValue0014Unsafe(final @NotNull char value0014) {
        UNSAFE.putChar(this, value0014FieldOffset, value0014);
    }

    public final void putValue0014Volatile(final @NotNull char value0014) {
        UNSAFE.putCharVolatile(this, value0014FieldOffset, value0014);
    }
    
    public final void setValue0015(final @NotNull char value0015) {
    ...
    public static  MutableTabledArray0016Char getInstance(
        final boolean checked, final int length, final @NotNull char ... values) {
        return new MutableTabledArray0016Char(checked, length, values) {
