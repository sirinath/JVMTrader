...
public abstract class MutableTabledArrayDouble extends ImmutableTabledArrayDouble {
    protected MutableTabledArrayDouble(final boolean checked, final int definedAsValues, final int length, final double ... values) {
        super(checked, definedAsValues, length, values);
    }


    public abstract void put(final int index, final double value);

    protected final void putToRest(final int index, final double value) {
    ...
    public static  MutableTabledArrayDouble getInstance(final boolean checked, final int length, final double ... values) {
        switch (length) {
            ...
            case 1024: 
                return MutableTabledArray1024Double.getInstance(checked, length, values);
