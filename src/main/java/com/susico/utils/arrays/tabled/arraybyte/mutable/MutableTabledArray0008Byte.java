...
public abstract class MutableTabledArray0008Byte extends MutableTabledArray0004Byte {
    ...
    public final void setValue0004(final byte value0004) {
        this.value0004 = value0004;
    }
    
    public final void setValue0005(final byte value0005) {
        this.value0005 = value0005;
    }
    
    public final void setValue0006(final byte value0006) {
        this.value0006 = value0006;
    }
    
    public final void setValue0007(final byte value0007) {
        this.value0007 = value0007;
    }
    
    protected MutableTabledArray0008Byte(final boolean checked, final byte ... values) {
        this(checked, 0, values);
    }

    protected MutableTabledArray0008Byte(final boolean checked, final int definedAsValues, final byte ... values) {
    ...
    public static  MutableTabledArray0008Byte getInstance(final boolean checked, final byte ... values) {
        return new MutableTabledArray0008Byte(checked, values) {
