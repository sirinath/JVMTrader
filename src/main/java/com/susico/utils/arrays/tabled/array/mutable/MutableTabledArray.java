...
public abstract class MutableTabledArray<T> extends ImmutableTabledArray<T> {
    protected MutableTabledArray(final boolean checked, final int definedAsValues, final T ... values) {
    ...
    protected final void putToRest(int index, T value) {
    ...
    public static <T> MutableTabledArray<T> getInstance(final boolean checked, final int length, final T ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000.getInstance(checked, values);
            case 1:
                return MutableTabledArray0001.getInstance(checked, values);
            case 2: 
                return MutableTabledArray0002.getInstance(checked, values);

            case 3: case 4: 
                return MutableTabledArray0004.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032.getInstance(checked, values);
            ...
            case 64: 
                return MutableTabledArray0064.getInstance(checked, values);
            ...
            case 128: 
                return MutableTabledArray0128.getInstance(checked, values);
            ...
            case 256: 
                return MutableTabledArray0256.getInstance(checked, values);
            ...
            case 512: 
                return MutableTabledArray0512.getInstance(checked, values);
            ...
            case 1024: 
                return MutableTabledArray1024.getInstance(checked, values);
            ...
            case 2048: 
                return MutableTabledArray2048.getInstance(checked, values);
            ...
            case 4096: 
                return MutableTabledArray4096.getInstance(checked, values);
            ...
            case 8192: 
                return MutableTabledArray8192.getInstance(checked, values);
