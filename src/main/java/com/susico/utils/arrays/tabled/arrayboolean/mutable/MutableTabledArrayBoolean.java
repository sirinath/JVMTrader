...
public abstract class MutableTabledArrayBoolean extends ImmutableTabledArrayBoolean {
    protected MutableTabledArrayBoolean(final boolean checked, final int definedAsValues, final int length, final @NotNull boolean ... values) {
        super(checked, definedAsValues, length, values);
    }

    protected final void putToRest(final int index, final @NotNull boolean value) {
        ARRAY_ACCESS.put(index - definedAsValues, (boolean[]) rest, (boolean) value);
    }

    protected final void putVolatileToRest(final int index, final @NotNull boolean value) {
        ARRAY_ACCESS.putVolatile(index - definedAsValues, (boolean[]) rest, (boolean) value);
    }

    public abstract void put(final int index, final @NotNull boolean value);

    public abstract void putUnsafe(final int index, final @NotNull boolean value);

    public abstract void putVolatile(final int index, final @NotNull boolean value);

    public static  MutableTabledArrayBoolean getInstance(
        final boolean checked, final int length, final @NotNull boolean ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000Boolean.getInstance(checked, length, values);
            case 1:
                return MutableTabledArray0001Boolean.getInstance(checked, length, values);
            case 2: 
                return MutableTabledArray0002Boolean.getInstance(checked, length, values);

            case 3: case 4: 
                return MutableTabledArray0004Boolean.getInstance(checked, length, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008Boolean.getInstance(checked, length, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016Boolean.getInstance(checked, length, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032Boolean.getInstance(checked, length, values);
            ...
            case 64: 
                return MutableTabledArray0064Boolean.getInstance(checked, length, values);
            ...
            case 128: 
                return MutableTabledArray0128Boolean.getInstance(checked, length, values);
            ...
            case 256: 
                return MutableTabledArray0256Boolean.getInstance(checked, length, values);
            ...
            case 512: 
                return MutableTabledArray0512Boolean.getInstance(checked, length, values);
