...
public abstract class MutableTabledArray0008Float extends MutableTabledArray0004Float {
    ...
    public final void setValue0004(final float value0004) {
        this.value0004 = value0004;
    }
    
    public final void setValue0005(final float value0005) {
        this.value0005 = value0005;
    }
    
    public final void setValue0006(final float value0006) {
        this.value0006 = value0006;
    }
    
    public final void setValue0007(final float value0007) {
        this.value0007 = value0007;
    }
    
    protected MutableTabledArray0008Float(final boolean checked, final float ... values) {
        this(checked, 0, values);
    }

    protected MutableTabledArray0008Float(final boolean checked, final int definedAsValues, final float ... values) {
    ...
    public static  MutableTabledArray0008Float getInstance(final boolean checked, final float ... values) {
        return new MutableTabledArray0008Float(checked, values) {
