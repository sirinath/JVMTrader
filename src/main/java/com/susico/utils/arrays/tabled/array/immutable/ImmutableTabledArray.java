...
public abstract class ImmutableTabledArray<T> extends TabledArray {
    ...
    protected ImmutableTabledArray(final boolean checked, final int definedAsValues, final T ... values) {
        super(checked, definedAsValues, values.length);
        this.rest = new Object[length > definedAsValues ? length - definedAsValues : 0];
    ...
    protected final T getFromRest(int index) {
    ...
    public static <T> ImmutableTabledArray<T> getInstance(final boolean checked, final int length, final T ... values) {
        switch (length) {
            case 0:
                return ImmutableTabledArray0000.getInstance(checked, values);
            case 1:
                return ImmutableTabledArray0001.getInstance(checked, values);
            case 2: 
                return ImmutableTabledArray0002.getInstance(checked, values);

            case 3: case 4: 
                return ImmutableTabledArray0004.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return ImmutableTabledArray0008.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return ImmutableTabledArray0016.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return ImmutableTabledArray0032.getInstance(checked, values);
            ...
            case 64: 
                return ImmutableTabledArray0064.getInstance(checked, values);
            ...
            case 128: 
                return ImmutableTabledArray0128.getInstance(checked, values);
            ...
            case 256: 
                return ImmutableTabledArray0256.getInstance(checked, values);
            ...
            case 512: 
                return ImmutableTabledArray0512.getInstance(checked, values);
            ...
            case 1024: 
                return ImmutableTabledArray1024.getInstance(checked, values);
            ...
            case 2048: 
                return ImmutableTabledArray2048.getInstance(checked, values);
            ...
            case 4096: 
                return ImmutableTabledArray4096.getInstance(checked, values);
            ...
            case 8192: 
                return ImmutableTabledArray8192.getInstance(checked, values);
