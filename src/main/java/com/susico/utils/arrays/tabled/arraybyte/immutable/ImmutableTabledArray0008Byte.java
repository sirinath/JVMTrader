...
public abstract class ImmutableTabledArray0008Byte extends ImmutableTabledArray0004Byte {
    ...
    protected ImmutableTabledArray0008Byte(final boolean checked, final int length, final byte ... values) {
        this(checked, 0, length, values);
    }

    protected ImmutableTabledArray0008Byte(final boolean checked, final int definedAsValues, final int length, final byte ... values) {
    ...
    public static  ImmutableTabledArray0008Byte getInstance(final boolean checked, final int length, final byte ... values) {
