...
public abstract class MutableTabledArrayDouble extends ImmutableTabledArrayDouble {
    protected MutableTabledArrayDouble(final boolean checked, final int definedAsValues, final double ... values) {
    ...
    protected final void putToRest(int index, double value) {
        ARRAY_ACCESS.put(rest, index - definedAsValues, value);
    }

    public static  MutableTabledArrayDouble getInstance(final boolean checked, final int length, final double ... values) {
        switch (length) {
            case 0:
                return MutableTabledArray0000Double.getInstance(checked, values);
            case 1:
                return MutableTabledArray0001Double.getInstance(checked, values);
            case 2: 
                return MutableTabledArray0002Double.getInstance(checked, values);

            case 3: case 4: 
                return MutableTabledArray0004Double.getInstance(checked, values);

            case 5: case 6: case 7: case 8: 
                return MutableTabledArray0008Double.getInstance(checked, values);

            case 9: case 10: case 11: case 12: case 13: case 14: case 15: 
            case 16: 
                return MutableTabledArray0016Double.getInstance(checked, values);

            case 17: case 18: case 19: case 20: case 21: case 22: case 23: case 24: case 25: case 26: case 27: case 28: case 29: case 30: case 31: 
            case 32: 
                return MutableTabledArray0032Double.getInstance(checked, values);
            ...
            case 64: 
                return MutableTabledArray0064Double.getInstance(checked, values);
            ...
            case 128: 
                return MutableTabledArray0128Double.getInstance(checked, values);
            ...
            case 256: 
                return MutableTabledArray0256Double.getInstance(checked, values);
            ...
            case 512: 
                return MutableTabledArray0512Double.getInstance(checked, values);
            ...
            case 1024: 
                return MutableTabledArray1024Double.getInstance(checked, values);
            ...
            case 2048: 
                return MutableTabledArray2048Double.getInstance(checked, values);
            ...
            case 4096: 
                return MutableTabledArray4096Double.getInstance(checked, values);
            ...
            case 8192: 
                return MutableTabledArray8192Double.getInstance(checked, values);
